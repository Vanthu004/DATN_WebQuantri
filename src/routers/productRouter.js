...
router.get('/search/enhanced', prodCtrl.enhancedSearchProducts);
router.get('/suggest', prodCtrl.suggestProducts);
router.get('/related', prodCtrl.getRelatedProducts);
router.get('/trending', prodCtrl.getTrendingProducts);
router.get('/personalized', prodCtrl.getPersonalizedSuggestions);
